...
def run(protocol: protocol_api.ProtocolContext):
    ...
    bsa_stock = tube_rack['D1']
    
    # Water source is in A1
    ...
    right_pipette.aspirate(800, water)
    ...
    right_pipette.pick_up_tip()
    right_pipette.mix(3, 400, bsa_stock)  # Mix 3 times with 400 µL
    right_pipette.blow_out(bsa_stock.top())
    right_pipette.aspirate(200, bsa_stock)
    right_pipette.dispense(200, cal_tube_1_a)
    ...
    right_pipette.pick_up_tip()
    right_pipette.mix(3, 200, bsa_stock)
    right_pipette.blow_out(bsa_stock.top())
    right_pipette.aspirate(200, bsa_stock)
    right_pipette.dispense(200, cal_tube_1_b)
